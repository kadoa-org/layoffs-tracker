...
export default function Masthead() {
  ...
  return (
    <>
            ...
            {TABS.map((t) => {
              ...
              return (
                ...
                >
                  {t.label}
                  {active && (
                    <span className="absolute left-2 right-2 bottom-[-1px] h-[2px] bg-accent rounded-t-full" />
                  )}
                </Link>
              );
            })}
      ...
      {/* Mounted as a sibling of <header>, not inside it. The header has
        `backdrop-blur` which creates a stacking context that traps the
        palette's own backdrop-filter and breaks the page-content blur. */}
